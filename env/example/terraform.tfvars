cluster_name = "opke-example"
dns_zone = "example-zone"

controller_count = "3"
controller_flavor_name = "Large_Linux"

worker_count = "4"
worker_flavor_name = "VeryLarge_Linux"

os_image_name = "coreOS-stable"

asset_dir = "./assets"
networking = "flannel"

host_cidr = "10.1.1.0/24"
pod_cidr = "10.1.2.0/24"
service_cidr = "10.1.3.0/24"

external_gateway_id = "some_ID"
floating_ip_pool = "public"
floating_id = "some_ID"
ca = <<EOF
-----BEGIN CERTIFICATE-----
          ThisisaFakeCA//IBAgIIH91XURY/6jowDQYJKoZIhvcNAQELBQAwETEPMA0GA1U
